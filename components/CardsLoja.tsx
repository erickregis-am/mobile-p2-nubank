...
export default function CardsDestaqueSEM({
    ...
    return (
        <View style={[stylesSEM.ContainerCardSEM, styleSEM]}>
            <Image 
                style={{width: "100%", height: "60%", borderTopRightRadius: 10, borderTopLeftRadius: 10, zIndex: 0}} 
            ...
            <View style={{
                width: "100%", 
                height: "40%", 
                backgroundColor: colorBottomSEM, 
                ...
                <View style={stylesSEM.ContainerIconandOfferSEM}>
                    ...
                    <View style={{
                        ...
                        width: widthSEM*0.25, 
                        height: heightSEM*0.04, 
                        borderRadius: 20, 
                        justifyContent: "center", 
                        alignItems: "center"
                    }}>
                        <Text className={'font-bold'} style={{color: '#810AD0'}}>
                            {descontOfferSEM}
                        </Text>
                    </View>
                </View>
                ...
                <View style={stylesSEM.ContainerTextsSEM}>
                    <Text className={'text-slate-400 font-md text-xl text-left'}>
                        {titleSEM}
                    </Text>
